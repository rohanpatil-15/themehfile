        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <img
              ...
              className="w-full h-full object-cover transform md:group-hover:scale-110 transition-transform duration-1000"
            />
            
            {/* Badges */}
            <motion.div animate={floatAnimation} className="absolute top-10 left-4 md:-left-12 glass px-4 md:px-6 py-2 md:py-3 rounded-2xl z-20 flex items-center gap-2 md:gap-3">
              <div className="bg-yellow-400/20 p-2 rounded-full">
                <Star className="w-5 h-5 md:w-6 md:h-6 text-yellow-400 fill-yellow-400" />
              </div>
              <div>
                <p className="text-white font-bold text-base md:text-lg leading-none">4.9/5</p>
                <p className="text-gray-400 text-[10px] md:text-xs">Top Rated</p>
              </div>
            </motion.div>

            <motion.div animate={floatAnimation} transition={{ delay: 1, duration: 4, repeat: Infinity }} className="absolute bottom-20 right-4 md:-right-8 glass px-4 md:px-6 py-2 md:py-3 rounded-2xl z-20 flex items-center gap-2 md:gap-3">
              <div className="bg-brand-gold/20 p-2 rounded-full">
                <Coffee className="w-5 h-5 md:w-6 md:h-6 text-brand-gold" />
              </div>
              <div>
                <p className="text-white font-bold text-base md:text-lg leading-none">Best Coffee</p>
                <p className="text-gray-400 text-[10px] md:text-xs">In Jalgaon</p>
              </div>
            </motion.div>
